...
use app\models\search\SysSettings as SysSettingsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * SysSettingsController implements the CRUD actions for SysSettings model.
 */
class SysSettingsController extends Controller
{
    ...
    /**
     * Deletes an existing SysSettings model.
    ...
    {
        if (($model = SysSettings::findOne(['id' => $id])) !== null) {
            return $model;
        }
