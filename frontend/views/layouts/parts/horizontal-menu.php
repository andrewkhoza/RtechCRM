         ...
         <div class="d-flex">
             ...
             <div class="navbar-brand-box">
                 <a href="<?= \Yii::$app->request->baseurl ?>/" class="logo logo-dark">
                     <span class="logo-sm">
                         <img src="<?= \Yii::$app->request->baseurl ?>/images/admin/logo.png" alt="" height="30">
                     </span>
                     <span class="logo-lg">
                         <img src="<?= \Yii::$app->request->baseurl ?>/images/admin/logo.png" alt="" height="24"> <!--span class="logo-txt">Dason</span-->
                     </span>
                 </a>
             ...
             <div class="collapse navbar-collapse" id="topnav-menu-content">
                 <ul class="navbar-nav">
                     ...
                     <li class="nav-item dropdown">
                         <a class="nav-link dropdown-toggle arrow-none" href="<?= \Yii::$app->request->baseurl ?>/" id="topnav-dashboard" role="button">
