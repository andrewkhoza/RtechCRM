 ...
 */
class BookedDevicesController extends Controller
{
    ...
    /**
     * Lists all BookedDevices models.
     *
     * @return string
     */
    ...
    /**
     * Displays a single BookedDevices model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Creates a new BookedDevices model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new BookedDevices();
    ...
    /**
     * Updates an existing BookedDevices model.
    ...
    /**
     * Deletes an existing BookedDevices model.
    ...
    /**
     * Finds the BookedDevices model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return BookedDevices the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = BookedDevices::findOne(['id' => $id])) !== null) {
            return $model;
        }
