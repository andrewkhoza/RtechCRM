            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'template' => ' {ready} {awaiting-parts} {write-off}', // Add a new button for duplication
                        'buttons' => [
                            'ready' => function ($url, $model, $key) {
                                return Html::a('<i class="fa fa-thumbs-up" ></i>', ['device-ready/ready-status','id'=> $model->id],['title'=>'ready for collection']);
                            },
                            'awaiting-parts' => function ($url, $model, $key) {
                                return Html::a('<i class="fa fa-hourglass-half" aria-hidden="true"></i>', ['awaiting-parts-status','id'=> $model->id],['title'=>'awaiting parts']);
                            },
