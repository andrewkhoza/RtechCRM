            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'template' => ' {update} {write-off}', // Add a new button for duplication
                        'buttons' => [
                            'update' => function ($url, $model, $key) {
                                return Html::a('<i class="fa fa-thumbs-up" aria-hidden="true"></i>', ['approved-status','id'=> $model->id],['title'=>'Parts Recieved']);
                            },
