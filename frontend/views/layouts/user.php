    ...
    <script>
        $( document ).ready(function() {
            $('.reveal-password3').click(function(){
                var ischeck = $('#resetpasswordformadmin-password').attr('type');
                if(ischeck == 'text'){
                    $('#resetpasswordformadmin-password').attr('type','password');
                }else{
                    $('#resetpasswordformadmin-password').attr('type','text');
                }
            });
            $('.reveal-password4').click(function(){
                var ischeck = $('#resetpasswordformadmin-password2').attr('type');
                if(ischeck == 'text'){
                    $('#resetpasswordformadmin-password2').attr('type','password');
                }else{
