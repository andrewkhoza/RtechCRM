                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td>
                                            ...
                                            /*$login = app\models\LoginHistory::find()->where(['user_id' => $user->id])->orderBy(['date' => SORT_DESC])->one();
                                            $content = str_replace('[[ip]]', $login->ip_address, $content);
                                            $content = str_replace('[[device]]', $login->device, $content);
                                            $content = str_replace('[[time]]', $login->date, $content);*/
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" class="mobile-button-container">
                                                            <tr>
                                                                <td align="center" style="border-radius: 3px;" bgcolor="#256F9C">
                                                                    <a href="<?= $fullurl  ?>frontend/web/site/lock-account/<?= $user->id ?>?token=<?= md5('bitwealth'.$user->id) ?>" target="_blank" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 15px 25px; border: 1px solid #256F9C; display: inline-block;" class="mobile-button">
                                                                        Lock Account &rarr;
                                                                    </a>
                                                                </td>
                                                            </tr>
