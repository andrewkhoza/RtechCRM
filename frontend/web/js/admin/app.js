...
(function ($) {
    ...
    function initActiveMenu() {
        ...
        $("#sidebar-menu a").each(function () {
            ...
            var mainpagesplits = pageUrl.split('/');
            var mainpage = '';
            var countmax = 4;
            if(mainpagesplits[2] == 'localhost' || mainpagesplits[2] == 'zilotesting.co.za' || mainpagesplits[2] == 'krytesting.co.za' || mainpagesplits[2] == 'https://hashtagtest.co.za/'){
                countmax = 5;
            }
            for (var i = 0; i < countmax; i++) {
                mainpage +=  mainpagesplits[i]+'/';
            }
            if(this.href.search( mainpage ) >= 0){
                mainactivecount++;
                if(mainactivecount <= 1){
                    mainactive = $(this);
                }
            }
        ...
        if(mainactivecount == 1){
            ...
            mainactive.parent().addClass("mm-active"); // add active to li of the current link
            mainactive.parent().parent().addClass("mm-show");
            mainactive.parent().parent().prev().addClass("mm-active"); // add active class to an anchor
            mainactive.parent().parent().parent().addClass("mm-active");
            mainactive.parent().parent().parent().parent().addClass("mm-show"); // add active to li of the current link
            mainactive.parent().parent().parent().parent().parent().addClass("mm-active");
        }
    }
