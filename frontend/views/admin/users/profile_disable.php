                ...
                <div class="card-body" >
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <hr>
                            <br>
                            <a class="btn btn-info" href="<?= \Yii::$app->request->baseurl ?>/admin/security" style="cursor: pointer;">Back</a>
                            <a class="btn btn-warning float-end" href="<?= \Yii::$app->request->baseurl ?>/admin/disable-account" style="cursor: pointer;">Disable Account</a>
                        </div>
